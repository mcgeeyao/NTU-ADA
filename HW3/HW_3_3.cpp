    ...
    while (cin >> n >> e) {
        ...
        while (cnt < n) {
            ...
            if (!nseen[v.second]) {
                ...
                for (auto& i:adj[v.second]) {
                    if (!nseen[i.first] && edgs[i.first] > i.second.first) {
        ...
        while (cnt < n) {
            ...
            if (nseen[v.second]) {
                ...
                for (auto& i:adj[v.second]) {
                    if (nseen[i.first] && dist[i.first] == dist[v.second] + i.second.first) {
                        parent[i.first] = v.second;
                    } else if (nseen[i.first] && dist[i.first] > dist[v.second] + i.second.first) {
